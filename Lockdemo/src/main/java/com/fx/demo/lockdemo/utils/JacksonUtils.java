package com.fx.demo.lockdemo.utils;
...
public class JacksonUtils {
    ...
    public static <T> List<T> json2list_unknown(String jsonArrayStr, Class<T> clazz) throws Exception {
     ...
     * @throws Exception
     */
    public static JsonNode json2listByTree(String jsonStr) throws Exception{
        JsonNode jsonNode = objectMapper.readTree(jsonStr);
        return jsonNode;
    }
